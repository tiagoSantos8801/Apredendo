...
public class ListaAlunosAdapter extends BaseAdapter {
     ...
     private void vincula(View view, Aluno aluno) {//Aluno da lista juntamente com a view
          TextView nome = view.findViewById(R.id.item_aluno_nome);
          nome.setText(aluno.getNome());
          TextView telefone = view.findViewById(R.id.item_aluno_telefone);
          new BuscaPrimeiroTelefoneDoAlunoTask(dao,
                  aluno.getId(),
                  new BuscaPrimeiroTelefoneDoAlunoTask.PrimeiroTelefoneEncontradoListner() {//Evita mandar o textView implementa aqui
                       @Override
...
//          Telefone primeiroTelefone = dao.buscarPrimeiroTelefoneDoAluno(aluno.getId());
